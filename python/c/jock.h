...
typedef void   (*IblJock_HandleConnect) (IblJock, IblSock, IblSockAddr);
typedef void   (*IblJock_HandleClose)   (IblJock, IblSock, IblSockAddr);
typedef size_t (*IblJock_HandleRead)    (IblJock, IblSock, IblSockAddr, byte*, size_t);
